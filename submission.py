...
with open("./train/final_model.pt", "rb") as f:
    try:
...
response = requests.post("http://34.122.51.94:9090/robustness", files={"file": open("./train/final_model.pt", "rb")}, headers={"token": "54614611", "model-name": "resnet50"})
